...
const body = `
  ...
  <p>aaa curabitur penatibus pulvinar consequat taciti nunc aptent libero feugiat, vitae platea accumsan tristique ligula viverra sollicitudin dolor mollis est, tempor nibh hac netus adipiscing felis odio rutrum.</p>
